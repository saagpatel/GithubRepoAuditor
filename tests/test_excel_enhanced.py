...
class TestAnalystWorkbookSheets:
    ...
    def test_standard_operator_sheets_include_trend_callouts(self):
        ...
        assert review_ws["A45"].value == "Reset Re-entry Rebuild Re-Entry Restore Re-Restore Refresh Recovery"
        assert review_ws["A46"].value == "Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Controls"
        ...
        assert executive_ws["D63"].value == "Reset Re-entry Rebuild Re-Entry Restore Re-Restore Refresh Recovery"
        assert executive_ws["D64"].value == "Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Controls"
        ...
        assert print_ws["A48"].value == "Reset Re-entry Rebuild Re-Entry Restore Re-Restore Refresh Recovery"
        assert print_ws["A49"].value == "Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Controls"
        ...
        assert "Reset Re-entry Rebuild Re-Entry Restore Re-Restore Refresh Recovery" in dashboard_values
        assert "Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Controls" in dashboard_values
