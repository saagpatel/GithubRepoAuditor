...
class TestAnalystWorkbookSheets:
    ...
    def test_standard_operator_sheets_include_trend_callouts(self):
        ...
        assert review_ws["A45"].value == "Reset Re-entry Rebuild Re-Entry Refresh Recovery"
        assert review_ws["A46"].value == "Reset Re-entry Rebuild Re-Entry Restore"
        ...
        assert executive_ws["D63"].value == "Reset Re-entry Rebuild Re-Entry Refresh Recovery"
        assert executive_ws["D64"].value == "Reset Re-entry Rebuild Re-Entry Restore"
        ...
        assert print_ws["A48"].value == "Reset Re-entry Rebuild Re-Entry Refresh Recovery"
        assert print_ws["A49"].value == "Reset Re-entry Rebuild Re-Entry Restore"
        ...
        assert "Reset Re-entry Rebuild Re-Entry Refresh Recovery" in dashboard_values
        assert "Reset Re-entry Rebuild Re-Entry Restore" in dashboard_values
