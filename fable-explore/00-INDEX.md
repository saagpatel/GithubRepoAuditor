...
| [07-essay-who-audits-the-auditor.md](07-essay-who-audits-the-auditor.md) | **B2 DRAFTED.** ~1,150-word essay for /writing. Opens on the 32→1 overnight collapse; four failures/four receipts (rollups-at-source, producer evidence, lineage, exclusions); seam linter; trust-chain limits. Reviewed against corpus rubrics (Dim 3: Survives), stop-slop clean, zero em dashes. | Draft for review |
| [08-note-anatomy-of-a-health-verdict.md](08-note-anatomy-of-a-health-verdict.md) | **B4 DRAFTED.** ~1,300-word note for /notes: the seven-stage teardown with the why behind each rule, honest blind-spot admissions (uncommitted work, universal thresholds, manual-only at ~half), "why there's no score" argument. Links the Verdict Machine + essay 07. | Draft for review |
...
| [09-essay-permission-to-ignore.md](09-essay-permission-to-ignore.md) | **B3 DRAFTED.** ~1,150-word essay for /writing: two-of-174 opener, wall-of-amber failure mode, three mechanisms of ignoring (deferred tier, lane vocabulary, capped queue + anti-busywork clause), steelman answered by deferral-downstream-of-declaration, trust condition pointing to 07. Zero em dashes, rubric-reviewed. | Draft for review |
