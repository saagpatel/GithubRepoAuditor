...
def render_scheduled_handoff_markdown(payload: dict) -> str:
    ...
    weekly_pack = payload.get("weekly_pack") or build_weekly_review_pack(payload, payload.get("diff_data"))
    ...
    lines = [
        ...
        f"- Reset re-entry refresh recovery: `{summary.get('primary_target_closure_forecast_reset_reentry_refresh_recovery_status', 'none')}` ({summary.get('primary_target_closure_forecast_reset_reentry_refresh_recovery_score', 0.0):.2f})",
        ...
        f"- Reset re-entry rebuild re-entry persistence: `{summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_persistence_status', 'none')}` ({summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_persistence_score', 0.0):.2f}; {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_age_runs', 0)} run(s))",
        f"- Reset re-entry rebuild re-entry churn controls: `{summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_churn_status', 'none')}` — {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_churn_reason', 'No reset re-entry rebuild re-entry churn reason is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry freshness: `{summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_freshness_status', 'insufficient-data')}` — {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_freshness_reason', 'No reset re-entry rebuild re-entry freshness reason is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry reset controls: `{summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_reset_status', 'none')}` — {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_reset_reason', 'No reset re-entry rebuild re-entry reset reason is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry refresh recovery: `{summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_status', 'none')}` — {summary.get('closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_summary', 'No reset re-entry rebuild re-entry refresh recovery summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry restore controls: `{summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_status', 'none')}` — {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_reason', 'No reset re-entry rebuild re-entry restore reason is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry restore freshness: `{summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_freshness_status', 'insufficient-data')}` — {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_freshness_reason', 'No reset re-entry rebuild re-entry restore freshness reason is recorded yet.')}",
        ...
        f"- Reset re-entry rebuild re-entry restore re-restore freshness: `{summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_freshness_status', 'insufficient-data')}` — {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_freshness_reason', 'No reset re-entry rebuild re-entry restore re-restore freshness reason is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry restore re-restore reset controls: `{summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_reset_status', 'none')}` — {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_reset_reason', 'No reset re-entry rebuild re-entry restore re-restore reset reason is recorded yet.')}",
        ...
        f"- Reset re-entry refresh recovery summary: {summary.get('closure_forecast_reset_reentry_refresh_recovery_summary', 'No reset re-entry refresh-recovery summary is recorded yet.')}",
        ...
        f"- Reset re-entry rebuild re-entry persistence summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_persistence_summary', 'No reset re-entry rebuild re-entry persistence summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry churn summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_churn_summary', 'No reset re-entry rebuild re-entry churn summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry freshness summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_freshness_summary', 'No reset re-entry rebuild re-entry freshness summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry reset summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_reset_summary', 'No reset re-entry rebuild re-entry reset summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry refresh recovery summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_summary', 'No reset re-entry rebuild re-entry refresh recovery summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry restore summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_summary', 'No reset re-entry rebuild re-entry restore summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry restore freshness summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_freshness_summary', 'No reset re-entry rebuild re-entry restore freshness summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry restore reset summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_reset_summary', 'No reset re-entry rebuild re-entry restore reset summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry restore refresh recovery summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_refresh_recovery_summary', 'No reset re-entry rebuild re-entry restore refresh recovery summary is recorded yet.')}",
        f"- Reset re-entry rebuild re-entry restore re-restore summary: {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_summary', 'No reset re-entry rebuild re-entry restore re-restore summary is recorded yet.')}",
    ...
    lines.append("")
    lines.append("## Reset Re-entry Persistence")
    lines.append("")
    lines.append(
        f"- Reset re-entry persistence: {summary.get('primary_target_closure_forecast_reset_reentry_persistence_status', 'none')} "
    ...
    if primary_target.get("recent_reset_reentry_persistence_path"):
        lines.append(
            f"- Recent reset re-entry persistence path: {primary_target.get('recent_reset_reentry_persistence_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_persistence_summary', 'No reset re-entry persistence summary is recorded yet.')}"
    )
    just_reentered_hotspots = summary.get("just_reentered_hotspots") or []
    holding_reset_reentry_hotspots = summary.get("holding_reset_reentry_hotspots") or []
    if just_reentered_hotspots:
        for hotspot in just_reentered_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Reset re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_persistence_status', 'just-reentered')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_persistence_score', 0.0):.2f}"
            )
    elif holding_reset_reentry_hotspots:
        for hotspot in holding_reset_reentry_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Reset re-entry holding hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_persistence_status', 'holding-confirmation-reentry')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_persistence_score', 0.0):.2f}"
            )
    else:
        lines.append("- No reset re-entry persistence hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Churn Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry churn: {summary.get('primary_target_closure_forecast_reset_reentry_churn_status', 'none')} "
        f"({summary.get('primary_target_closure_forecast_reset_reentry_churn_reason', 'No reset re-entry churn reason is recorded yet.')})"
    )
    if primary_target.get("recent_reset_reentry_churn_path"):
        lines.append(
            f"- Recent reset re-entry churn path: {primary_target.get('recent_reset_reentry_churn_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_churn_summary', 'No reset re-entry churn summary is recorded yet.')}"
    )
    reset_reentry_churn_hotspots = summary.get("reset_reentry_churn_hotspots") or []
    if reset_reentry_churn_hotspots:
        for hotspot in reset_reentry_churn_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Reset re-entry churn hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_churn_status', 'watch')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_churn_score', 0.0):.2f}"
            )
    else:
    ...
    lines.append("")
    lines.append("## Reset Re-entry Refresh Recovery")
    lines.append("")
    lines.append(
        f"- Reset re-entry refresh recovery: {summary.get('primary_target_closure_forecast_reset_reentry_refresh_recovery_status', 'none')} "
        f"({summary.get('primary_target_closure_forecast_reset_reentry_refresh_recovery_score', 0.0):.2f})"
    )
    if primary_target.get("recent_reset_reentry_refresh_path"):
        lines.append(
            f"- Recent reset re-entry refresh path: {primary_target.get('recent_reset_reentry_refresh_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_refresh_recovery_summary', 'No reset re-entry refresh-recovery summary is recorded yet.')}"
    )
    recovering_from_confirmation_reentry_reset_hotspots = summary.get("recovering_from_confirmation_reentry_reset_hotspots") or []
    recovering_from_clearance_reentry_reset_hotspots = summary.get("recovering_from_clearance_reentry_reset_hotspots") or []
    if recovering_from_confirmation_reentry_reset_hotspots:
        for hotspot in recovering_from_confirmation_reentry_reset_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Confirmation reset re-entry recovery hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_refresh_recovery_status', 'recovering-confirmation-reentry-reset')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_refresh_recovery_score', 0.0):.2f}"
            )
    elif recovering_from_clearance_reentry_reset_hotspots:
        for hotspot in recovering_from_clearance_reentry_reset_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Clearance reset re-entry recovery hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_refresh_recovery_status', 'recovering-clearance-reentry-reset')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_refresh_recovery_score', 0.0):.2f}"
            )
    else:
        lines.append("- No reset re-entry refresh-recovery hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_status', 'none')} "
    ...
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_summary', 'No reset re-entry rebuild summary is recorded yet.')}"
    )
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Freshness")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild freshness: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_freshness_status', 'insufficient-data')} "
    ...
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_freshness_summary', 'No reset re-entry rebuild-freshness summary is recorded yet.')}"
    )
    stale_reset_reentry_rebuild_hotspots = summary.get(
        "stale_reset_reentry_rebuild_hotspots"
    ) or []
    fresh_reset_reentry_rebuild_signal_hotspots = summary.get(
        "fresh_reset_reentry_rebuild_signal_hotspots"
    ) or []
    if fresh_reset_reentry_rebuild_signal_hotspots:
        for hotspot in fresh_reset_reentry_rebuild_signal_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Fresh rebuilt hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_freshness_status', 'fresh')} with "
                f"{hotspot.get('recent_reset_reentry_rebuild_signal_mix', 'no rebuilt signal mix recorded')}"
            )
    elif stale_reset_reentry_rebuild_hotspots:
        for hotspot in stale_reset_reentry_rebuild_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Stale rebuilt hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_freshness_status', 'stale')} with "
                f"{hotspot.get('recent_reset_reentry_rebuild_signal_mix', 'no rebuilt signal mix recorded')}"
            )
    else:
        lines.append("- No rebuilt-freshness hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Reset Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild reset: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reset_status', 'none')} "
    ...
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Persistence")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry persistence: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_persistence_status', 'none')} "
    ...
    if primary_target.get("recent_reset_reentry_rebuild_reentry_persistence_path"):
        lines.append(
            f"- Recent reset re-entry rebuild re-entry persistence path: {primary_target.get('recent_reset_reentry_rebuild_reentry_persistence_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_persistence_summary', 'No reset re-entry rebuild re-entry persistence summary is recorded yet.')}"
    )
    just_reentered_rebuild_hotspots = summary.get("just_reentered_rebuild_hotspots") or []
    holding_reset_reentry_rebuild_reentry_hotspots = summary.get(
        "holding_reset_reentry_rebuild_reentry_hotspots"
    ) or []
    if just_reentered_rebuild_hotspots:
        for hotspot in just_reentered_rebuild_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Just re-entered rebuild hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_persistence_status', 'just-reentered')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_persistence_score', 0.0):.2f} across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_persistence_path', 'no rebuild re-entry persistence path recorded')}"
            )
    elif holding_reset_reentry_rebuild_reentry_hotspots:
        for hotspot in holding_reset_reentry_rebuild_reentry_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Holding rebuild re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_persistence_status', 'holding-confirmation-rebuild-reentry')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_persistence_score', 0.0):.2f} across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_persistence_path', 'no rebuild re-entry persistence path recorded')}"
            )
    else:
        lines.append("- No rebuilt re-entry persistence hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Churn Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry churn: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_churn_status', 'none')} "
    ...
    if primary_target.get("recent_reset_reentry_rebuild_reentry_churn_path"):
        lines.append(
            f"- Recent reset re-entry rebuild re-entry churn path: {primary_target.get('recent_reset_reentry_rebuild_reentry_churn_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_churn_summary', 'No reset re-entry rebuild re-entry churn summary is recorded yet.')}"
    )
    reset_reentry_rebuild_reentry_churn_hotspots = summary.get(
        "reset_reentry_rebuild_reentry_churn_hotspots"
    ) or []
    if reset_reentry_rebuild_reentry_churn_hotspots:
        for hotspot in reset_reentry_rebuild_reentry_churn_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Rebuild re-entry churn hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_churn_status', 'watch')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_churn_score', 0.0):.2f} across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_churn_path', 'no rebuild re-entry churn path recorded')}"
            )
    else:
        lines.append("- No rebuilt re-entry churn hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Freshness")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry freshness: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_freshness_status', 'insufficient-data')} "
    ...
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_freshness_summary', 'No reset re-entry rebuild re-entry freshness summary is recorded yet.')}"
    )
    stale_reset_reentry_rebuild_reentry_hotspots = summary.get(
        "stale_reset_reentry_rebuild_reentry_hotspots"
    ) or []
    fresh_reset_reentry_rebuild_reentry_signal_hotspots = summary.get(
        "fresh_reset_reentry_rebuild_reentry_signal_hotspots"
    ) or []
    if fresh_reset_reentry_rebuild_reentry_signal_hotspots:
        for hotspot in fresh_reset_reentry_rebuild_reentry_signal_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Fresh rebuilt re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_freshness_status', 'fresh')} with "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_signal_mix', 'no rebuilt re-entry signal mix recorded')}"
            )
    elif stale_reset_reentry_rebuild_reentry_hotspots:
        for hotspot in stale_reset_reentry_rebuild_reentry_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Stale rebuilt re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_freshness_status', 'stale')} with "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_signal_mix', 'no rebuilt re-entry signal mix recorded')}"
            )
    else:
        lines.append("- No rebuilt re-entry freshness hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Reset Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry reset: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_reset_status', 'none')} "
    ...
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_reset_summary', 'No reset re-entry rebuild re-entry reset summary is recorded yet.')}"
    )
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Refresh Recovery")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry refresh recovery: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_status', 'none')} "
    ...
    refresh_reentry_confirmation_hotspots = summary.get(
        "recovering_from_confirmation_rebuild_reentry_reset_hotspots"
    ) or []
    refresh_reentry_clearance_hotspots = summary.get(
        "recovering_from_clearance_rebuild_reentry_reset_hotspots"
    ) or []
    if refresh_reentry_confirmation_hotspots:
        for hotspot in refresh_reentry_confirmation_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Recovering rebuilt re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_status', 'recovering-confirmation-rebuild-reentry-reset')} "
                f"({hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_score', 0.0):.2f})"
            )
    elif refresh_reentry_clearance_hotspots:
        for hotspot in refresh_reentry_clearance_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Recovering rebuilt re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_status', 'recovering-clearance-rebuild-reentry-reset')} "
                f"({hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_score', 0.0):.2f})"
            )
    else:
        lines.append("- No rebuilt re-entry refresh-recovery hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_status', 'none')} "
    ...
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_summary', 'No reset re-entry rebuild re-entry restore summary is recorded yet.')}"
    )
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Freshness")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore freshness: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_freshness_status', 'insufficient-data')} "
    ...
    if primary_target.get("recent_reset_reentry_rebuild_reentry_restore_signal_mix"):
        lines.append(
            f"- Recent reset re-entry rebuild re-entry restore signal mix: {primary_target.get('recent_reset_reentry_rebuild_reentry_restore_signal_mix')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_freshness_summary', 'No reset re-entry rebuild re-entry restore freshness summary is recorded yet.')}"
    )
    stale_reset_reentry_rebuild_reentry_restore_hotspots = summary.get(
        "stale_reset_reentry_rebuild_reentry_restore_hotspots"
    ) or []
    fresh_reset_reentry_rebuild_reentry_restore_signal_hotspots = summary.get(
        "fresh_reset_reentry_rebuild_reentry_restore_signal_hotspots"
    ) or []
    if stale_reset_reentry_rebuild_reentry_restore_hotspots:
        for hotspot in stale_reset_reentry_rebuild_reentry_restore_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Stale restored rebuilt re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_freshness_status', 'stale')} with "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_memory_weight', 0.0):.2f} weighted memory across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_signal_mix', 'no restored rebuilt re-entry signal mix recorded')}"
            )
    elif fresh_reset_reentry_rebuild_reentry_restore_signal_hotspots:
        for hotspot in fresh_reset_reentry_rebuild_reentry_restore_signal_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Fresh restored rebuilt re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_freshness_status', 'fresh')} with "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_memory_weight', 0.0):.2f} weighted memory across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_signal_mix', 'no restored rebuilt re-entry signal mix recorded')}"
            )
    else:
        lines.append("- No restored rebuilt re-entry freshness hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Reset Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore reset controls: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_reset_status', 'none')} "
    ...
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_reset_summary', 'No reset re-entry rebuild re-entry restore reset summary is recorded yet.')}"
    )
    reset_hotspots = (
        stale_reset_reentry_rebuild_reentry_restore_hotspots
        or fresh_reset_reentry_rebuild_reentry_restore_signal_hotspots
    )
    if reset_hotspots:
        for hotspot in reset_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Restore reset hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_reset_status', 'none')} across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_signal_mix', 'no restored rebuilt re-entry signal mix recorded')}"
            )
    else:
        lines.append("- No restored rebuilt re-entry reset hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Refresh Recovery")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore refresh recovery: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_refresh_recovery_status', 'none')} "
    ...
    restore_refresh_hotspots = summary.get(
    ...
    if restore_refresh_hotspots:
        for hotspot in restore_refresh_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Restore refresh hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_refresh_recovery_status', 'none')} "
                f"({hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_refresh_recovery_score', 0.0):.2f}) via "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_refresh_path', 'no restore refresh path recorded')}"
            )
    else:
        lines.append("- No restored rebuilt re-entry refresh-recovery hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Re-Restore Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore re-restore controls: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_status', 'none')} "
    ...
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Re-Restore Freshness")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore re-restore freshness: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_freshness_status', 'insufficient-data')} "
    ...
    if primary_target.get("recent_reset_reentry_rebuild_reentry_restore_rerestore_signal_mix"):
        lines.append(
            f"- Recent reset re-entry rebuild re-entry restore re-restore signal mix: {primary_target.get('recent_reset_reentry_rebuild_reentry_restore_rerestore_signal_mix')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_freshness_summary', 'No reset re-entry rebuild re-entry restore re-restore freshness summary is recorded yet.')}"
    )
    stale_rerestore_hotspots = summary.get(
        "stale_reset_reentry_rebuild_reentry_restore_rerestore_hotspots"
    ) or []
    fresh_rerestore_hotspots = summary.get(
        "fresh_reset_reentry_rebuild_reentry_restore_rerestore_signal_hotspots"
    ) or []
    if stale_rerestore_hotspots:
        for hotspot in stale_rerestore_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Stale rerestored rebuilt re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_freshness_status', 'stale')} with "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_memory_weight', 0.0):.2f} weighted memory across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_rerestore_signal_mix', 'no rerestored rebuilt re-entry signal mix recorded')}"
            )
    elif fresh_rerestore_hotspots:
        for hotspot in fresh_rerestore_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Fresh rerestored rebuilt re-entry hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_freshness_status', 'fresh')} with "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_memory_weight', 0.0):.2f} weighted memory across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_rerestore_signal_mix', 'no rerestored rebuilt re-entry signal mix recorded')}"
            )
    else:
        lines.append("- No rerestored rebuilt re-entry freshness hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Re-Restore Reset Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore re-restore reset controls: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_reset_status', 'none')} "
    ...
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_reset_summary', 'No reset re-entry rebuild re-entry restore re-restore reset summary is recorded yet.')}"
    )
    rerestore_reset_hotspots = stale_rerestore_hotspots or fresh_rerestore_hotspots
    if rerestore_reset_hotspots:
        for hotspot in rerestore_reset_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Rerestore reset hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_reset_status', 'none')} across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_rerestore_signal_mix', 'no rerestored rebuilt re-entry signal mix recorded')}"
            )
    else:
        lines.append("- No rerestored rebuilt re-entry reset hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Re-Restore Refresh Recovery")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore re-restore refresh recovery: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_refresh_recovery_status', 'none')} "
    ...
    if primary_target.get("recent_reset_reentry_rebuild_reentry_restore_rerestore_refresh_path"):
        lines.append(
            f"- Recent reset re-entry rebuild re-entry restore re-restore refresh path: {primary_target.get('recent_reset_reentry_rebuild_reentry_restore_rerestore_refresh_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_refresh_recovery_summary', 'No reset re-entry rebuild re-entry restore re-restore refresh recovery summary is recorded yet.')}"
    )
    rerestore_refresh_hotspots = summary.get(
    ...
    if rerestore_refresh_hotspots:
        for hotspot in rerestore_refresh_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Rerestore refresh hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_refresh_recovery_status', 'none')} "
                f"({hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_refresh_recovery_score', 0.0):.2f}) via "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_rerestore_refresh_path', 'no rerestore refresh path recorded')}"
            )
    else:
        lines.append("- No rerestored rebuilt re-entry refresh-recovery hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore re-re-restore controls: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_status', 'none')} "
    ...
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_summary', 'No reset re-entry rebuild re-entry restore re-re-restore summary is recorded yet.')}"
    )
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Persistence")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore re-re-restore persistence: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_persistence_status', 'none')} "
    ...
    if primary_target.get("recent_reset_reentry_rebuild_reentry_restore_rererestore_persistence_path"):
        lines.append(
            f"- Recent reset re-entry rebuild re-entry restore re-re-restore persistence path: {primary_target.get('recent_reset_reentry_rebuild_reentry_restore_rererestore_persistence_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_persistence_summary', 'No reset re-entry rebuild re-entry restore re-re-restore persistence summary is recorded yet.')}"
    )
    rererestore_persistence_hotspots = summary.get(
        "just_rererestored_rebuild_reentry_hotspots"
    ) or summary.get(
        "holding_reset_reentry_rebuild_reentry_restore_rererestore_hotspots"
    ) or []
    if rererestore_persistence_hotspots:
        for hotspot in rererestore_persistence_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Re-re-restore persistence hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_persistence_status', 'none')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_persistence_score', 0.0):.2f} across "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_rererestore_persistence_path', 'no re-re-restore persistence path recorded')}"
            )
    else:
        lines.append("- No re-re-restored persistence hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Churn Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild re-entry restore re-re-restore churn controls: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_churn_status', 'none')} "
    ...
    if primary_target.get("recent_reset_reentry_rebuild_reentry_restore_rererestore_churn_path"):
        lines.append(
            f"- Recent reset re-entry rebuild re-entry restore re-re-restore churn path: {primary_target.get('recent_reset_reentry_rebuild_reentry_restore_rererestore_churn_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_churn_summary', 'No reset re-entry rebuild re-entry restore re-re-restore churn summary is recorded yet.')}"
    )
    rererestore_churn_hotspots = summary.get(
        "reset_reentry_rebuild_reentry_restore_rererestore_churn_hotspots"
    ) or []
    if rererestore_churn_hotspots:
        for hotspot in rererestore_churn_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Re-re-restore churn hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_churn_status', 'none')} "
                f"({hotspot.get('closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_churn_score', 0.0):.2f}) via "
                f"{hotspot.get('recent_reset_reentry_rebuild_reentry_restore_rererestore_churn_path', 'no re-re-restore churn path recorded')}"
            )
    else:
    ...
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild persistence: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_persistence_status', 'none')} "
    ...
    if primary_target.get("recent_reset_reentry_rebuild_persistence_path"):
        lines.append(
            f"- Recent reset re-entry rebuild persistence path: {primary_target.get('recent_reset_reentry_rebuild_persistence_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_persistence_summary', 'No reset re-entry rebuild-persistence summary is recorded yet.')}"
    )
    just_rebuilt_hotspots = summary.get("just_rebuilt_hotspots") or []
    holding_reset_reentry_rebuild_hotspots = summary.get(
        "holding_reset_reentry_rebuild_hotspots"
    ) or []
    if just_rebuilt_hotspots:
        for hotspot in just_rebuilt_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Just rebuilt hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_persistence_status', 'just-rebuilt')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_persistence_score', 0.0):.2f} across "
                f"{hotspot.get('recent_reset_reentry_rebuild_persistence_path', 'no rebuild persistence path recorded')}"
            )
    elif holding_reset_reentry_rebuild_hotspots:
        for hotspot in holding_reset_reentry_rebuild_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Holding rebuild hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_persistence_status', 'holding-confirmation-rebuild')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_persistence_score', 0.0):.2f} across "
                f"{hotspot.get('recent_reset_reentry_rebuild_persistence_path', 'no rebuild persistence path recorded')}"
            )
    else:
        lines.append("- No rebuild-persistence hotspots are recorded in the recent window.")
    lines.append("")
    lines.append("## Reset Re-entry Rebuild Churn Controls")
    lines.append("")
    lines.append(
        f"- Reset re-entry rebuild churn: {summary.get('primary_target_closure_forecast_reset_reentry_rebuild_churn_status', 'none')} "
    ...
    if primary_target.get("recent_reset_reentry_rebuild_churn_path"):
        lines.append(
            f"- Recent reset re-entry rebuild churn path: {primary_target.get('recent_reset_reentry_rebuild_churn_path')}"
        )
    lines.append(
        f"- {summary.get('closure_forecast_reset_reentry_rebuild_churn_summary', 'No reset re-entry rebuild-churn summary is recorded yet.')}"
    )
    reset_reentry_rebuild_churn_hotspots = summary.get(
        "reset_reentry_rebuild_churn_hotspots"
    ) or []
    if reset_reentry_rebuild_churn_hotspots:
        for hotspot in reset_reentry_rebuild_churn_hotspots[:3]:
            lines.append(
                f"- {hotspot.get('label', 'Rebuild churn hotspot')} [{hotspot.get('scope', 'class')}] -> "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_churn_status', 'watch')} at "
                f"{hotspot.get('closure_forecast_reset_reentry_rebuild_churn_score', 0.0):.2f} across "
                f"{hotspot.get('recent_reset_reentry_rebuild_churn_path', 'no rebuild churn path recorded')}"
            )
    else:
        lines.append("- No rebuild-churn hotspots are recorded in the recent window.")
    lines.append("")
...
def build_scheduled_handoff(
    ...
    *,
    ...
    payload = {
        ...
        "diff_data": diff_data,
        "weekly_pack": build_weekly_review_pack(control_center, diff_data),
