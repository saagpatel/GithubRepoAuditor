...
def _operator_transition_closure_values(data: dict) -> tuple[str, str, str, str, str, str, str]:
    ...
    reset_reentry_rebuild_reentry_restore_rererestore_freshness = (
        summary.get(
    ...
    reset_reentry_rebuild_reentry_restore_rererestore_reset = (
        summary.get(
    ...
    closure_summary = (
        summary.get("closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_freshness_summary")
    ...
    if excel_mode == "standard":
        operator_rows.extend(
            [
                ...
                ("Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Freshness", reset_reentry_rebuild_reentry_restore_rererestore_freshness),
                ("Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Reset Controls", reset_reentry_rebuild_reentry_restore_rererestore_reset),
...
def _build_executive_summary(
    ...
    *,
    ...
    if excel_mode == "standard":
        ...
        narrative_rows.insert(34, ("Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Freshness", reset_reentry_rebuild_reentry_restore_rererestore_freshness))
        narrative_rows.insert(35, ("Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Reset Controls", reset_reentry_rebuild_reentry_restore_rererestore_reset))
    ...
    if operator_summary:
        ...
        if excel_mode == "standard":
            ...
            ws.cell(row=63, column=4, value="Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Freshness").font = SUBHEADER_FONT
            ws.cell(row=63, column=5, value=reset_reentry_rebuild_reentry_restore_rererestore_freshness)
            ws.cell(row=64, column=4, value="Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Reset Controls").font = SUBHEADER_FONT
            ws.cell(row=64, column=5, value=reset_reentry_rebuild_reentry_restore_rererestore_reset)
...
def _build_print_pack(
    ...
    *,
    ...
    if excel_mode == "standard":
        ...
        ws["A48"] = "Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Freshness"
        ws["B48"] = reset_reentry_rebuild_reentry_restore_rererestore_freshness
        ws["A49"] = "Reset Re-entry Rebuild Re-Entry Restore Re-Re-Restore Reset Controls"
        ws["B49"] = reset_reentry_rebuild_reentry_restore_rererestore_reset
