...
from github_repo_auditor.portfolio_truth_render import render_portfolio_report_markdown, render_registry_markdown
...
from github_repo_auditor.producer_preflight import ProducerEvidence, verify_evidence_still_current
...
from github_repo_auditor.project_registry import build_project_registry, load_source_paths
...
def _build_project_registry_json(snapshot, *, include_notion: bool) -> str:
    ...
    if include_notion and sources.get("scoring_data_source_id"):
        try:
            from github_repo_auditor.notion_client import get_notion_token
            from github_repo_auditor.project_registry import fetch_scoring_pageids
