...
from github_repo_auditor.automation_proposals import AutomationProposal, require_approved
...
def execute_catalog_seed(
    ...
    *,
    ...
    if apply_seeds is None:
        from github_repo_auditor.portfolio_context_recovery import _merge_catalog_seeds
