...
from github_repo_auditor.demo_portfolio import DEMO_PROJECTS, DemoProject, build_snapshot
...
def build_contract_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "producer": {
            ...
            "generator": (
                "github_repo_auditor.portfolio_truth_contract_fixture:build_contract_fixture"
            ),
...
def build_consumer_profile_manifest(profile_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "producer": {
            "repository": PRODUCER_REPOSITORY,
            "generator": (
                "github_repo_auditor.portfolio_truth_contract_fixture:"
