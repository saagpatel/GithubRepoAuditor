...
from github_repo_auditor.narrative import _resolve_provider
...
class DismissedSuggestion:
    ...
    dismissed_by: str  # operator_identity() from github_repo_auditor.initiatives
...
def dismiss_suggestion_record(
    ...
    from github_repo_auditor.initiatives import operator_identity
...
def narrow_candidates(
    ...
    """
    from github_repo_auditor.maturity_tiers import TierGap, compute_tier, tier_gap
...
def generate_suggestions(
    ...
    # Resolve LLM provider (module-level import so tests can patch github_repo_auditor.suggest_initiatives._resolve_provider)
