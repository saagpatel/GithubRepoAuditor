...
from github_repo_auditor.portfolio_context_contract import has_substantive_readme_support
from github_repo_auditor.portfolio_pathing import build_operating_path_entry
from github_repo_auditor.portfolio_repository_state import observe_repository_state
from github_repo_auditor.portfolio_truth_coverage import build_coverage_envelope
from github_repo_auditor.portfolio_truth_decisions import build_project_decision
from github_repo_auditor.portfolio_truth_metadata import (
    build_exclusions,
    build_input_envelope,
    build_source_summary,
    build_warnings,
)
from github_repo_auditor.portfolio_truth_precedence import build_precedence_matrix
...
from github_repo_auditor.project_registry import DEFAULT_SUPPLEMENTARY
...
# ── Strict signal constants (mirror src/github_repo_auditor/analyzers/testing.py and cicd.py) ──
