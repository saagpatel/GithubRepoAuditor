...
from github_repo_auditor.scoring_dimensions import (
...
def score_repo(
    ...
    *,
    ...
    if portfolio_lang_freq and metadata.language:
        from github_repo_auditor.analyzers.interest import NOVEL_LANGUAGES
    ...
    from github_repo_auditor.portfolio_intelligence import (
