...
from github_repo_auditor.excel_template import DEFAULT_TEMPLATE_PATH, load_workbook_allowing_native_sparklines
from github_repo_auditor.excel_workbook_helpers import CORE_VISIBLE_SHEETS
...
def _sample_report_data() -> dict:
    return {
        ...
        "operator_summary": {
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_freshness_summary": "RepoC: Security posture needs attention still has useful rebuilt re-entry memory, but the restored posture is no longer getting fully fresh reinforcement.",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_reset_summary": "Rebuilt re-entry posture for RepoC: Security posture needs attention is aging enough that it can keep holding, but it should no longer stay indefinitely at sustained strength.",
            "primary_target_closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_score": 0.28,
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_refresh_recovery_summary": "Fresh confirmation-side evidence is returning for RepoC: Security posture needs attention after rebuilt re-entry softened, but it has not yet restored stronger rebuilt re-entry posture (0.28).",
            "closure_forecast_reset_reentry_rebuild_reentry_restore_summary": "RepoC: Security posture needs attention is recovering after rebuilt re-entry softened, but stronger rebuilt re-entry posture still needs more fresh follow-through before it is restored.",
            "primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_age_runs": 1,
            "primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_persistence_score": 0.24,
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_persistence_summary": "RepoC: Security posture needs attention has only just restored stronger rebuilt re-entry posture, so it is still fragile (0.24; 1 run).",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_freshness_summary": "RepoC: Security posture needs attention still has useful restored rebuilt re-entry memory, but the restored posture is no longer getting fully fresh reinforcement.",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_reset_summary": "Restored rebuilt re-entry posture for RepoC: Security posture needs attention is aging enough that it can keep holding, but it should no longer stay indefinitely at sustained strength.",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_refresh_recovery_summary": "Fresh confirmation-side evidence is returning for RepoC: Security posture needs attention after restored rebuilt re-entry softened, but it has not yet re-restored stronger restored posture (0.31).",
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_summary": "RepoC: Security posture needs attention is recovering after restored rebuilt re-entry softened, but stronger restored posture still needs more fresh follow-through before it is re-restored.",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_persistence_summary": "RepoC: Security posture needs attention has only just re-restored stronger restored rebuilt re-entry posture, so it is still fragile (0.18; 1 run).",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_freshness_summary": "RepoC: Security posture needs attention still has useful rerestored rebuilt re-entry memory, but the stronger posture is no longer getting fully fresh reinforcement.",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_reset_summary": "Rerestored rebuilt re-entry posture for RepoC: Security posture needs attention is aging enough that it can keep holding, but it should no longer stay indefinitely at sustained strength.",
            ...
            "primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_persistence_score": 0.31,
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_persistence_summary": "RepoC: Security posture needs attention has held re-re-restored confirmation-side posture long enough to keep the stronger rerestored forecast in place (0.31; 2 runs).",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_churn_summary": "Re-re-restored rebuilt re-entry for RepoC: Security posture needs attention is wobbling enough that stronger rerestored posture may soften soon (0.22).",
            "primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_freshness_status": "mixed-age",
            "primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_freshness_reason": "Re-re-restored rebuilt re-entry memory is still useful, but it is partly aging: 50% of the weighted signal is recent and the rest is older carry-forward.",
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_freshness_summary": "RepoC: Security posture needs attention still has useful re-re-restored rebuilt re-entry memory, but the stronger posture is no longer getting fully fresh reinforcement.",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_reset_summary": "Re-re-restored rebuilt re-entry posture for RepoC: Security posture needs attention is aging enough that it can keep holding, but it should no longer stay indefinitely at sustained strength.",
            "primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_refresh_recovery_score": 0.28,
            ...
            "primary_target_closure_forecast_reset_reentry_rebuild_reentry_restore_rerererestore_reason": "Fresh confirmation-side evidence is returning after re-re-restored rebuilt re-entry softened or reset, but it has not yet re-re-re-restored stronger re-re-restored posture.",
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_refresh_recovery_summary": "Fresh confirmation-side evidence is returning for RepoC: Security posture needs attention after re-re-restored posture softened, but it has not yet re-re-re-restored stronger re-re-restored posture (0.28).",
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerererestore_summary": "RepoC: Security posture needs attention is recovering after stronger re-re-restored posture softened, but it still needs more fresh follow-through before it is re-re-re-restored.",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerererestore_persistence_summary": "RepoC: Security posture needs attention has only just re-re-re-restored stronger re-re-restored posture, so it is still fragile (0.24; 1 run).",
            ...
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerererestore_churn_summary": "Re-re-re-restored rebuilt re-entry for RepoC: Security posture needs attention is wobbling enough that stronger re-re-restored posture may soften soon (0.21).",
            "reset_reentry_rebuild_reentry_restore_rerererestore_churn_hotspots": [],
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_refresh_recovery_summary": "Fresh confirmation-side evidence is returning for RepoC: Security posture needs attention after stronger rerestored posture softened, but it has not yet re-re-restored stronger posture (0.34).",
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_summary": "RepoC: Security posture needs attention is recovering after stronger rerestored posture softened, but it still needs more fresh follow-through before it is re-re-restored.",
            ...
            "decayed_rererestored_rebuild_reentry_confirmation_rate": 0.54,
            "decayed_rererestored_rebuild_reentry_clearance_rate": 0.18,
            "recent_reset_reentry_rebuild_reentry_restore_rererestore_signal_mix": "2.40 weighted re-re-restored run(s) with 1.30 confirmation-like, 0.43 clearance-like, and 50% of the signal from the freshest runs.",
            "closure_forecast_reset_reentry_rebuild_reentry_restore_refresh_window_runs": 4,
            "closure_forecast_reset_reentry_rebuild_reentry_restore_decay_window_runs": 4,
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_window_runs": 4,
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rerestore_decay_window_runs": 4,
            "closure_forecast_reset_reentry_rebuild_reentry_restore_rererestore_decay_window_runs": 4,
            ...
            "closure_forecast_reset_reentry_window_runs": 4,
