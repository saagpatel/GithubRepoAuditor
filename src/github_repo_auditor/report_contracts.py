...
produced by `src/github_repo_auditor/weekly_packaging.py` (`_build_weekly_story_v1` and its
evidence-item helpers) and `src/github_repo_auditor/report_enrichment.py`
