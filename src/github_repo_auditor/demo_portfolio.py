...
from github_repo_auditor.portfolio_truth_types import DERIVATION_POLICY_VERSION, SCHEMA_VERSION
...
def build_snapshot(
    ...
    *,
    ...
    from github_repo_auditor.portfolio_truth_validate import canonicalize_truth_snapshot_payload
