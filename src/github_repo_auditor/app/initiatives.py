...
from github_repo_auditor.cli_output import print_info, print_warning
from github_repo_auditor.portfolio_truth_types import TRUTH_LATEST_FILENAME, truth_latest_path


def run_set_initiative_mode(args) -> None:
    """Validate and persist a tier-upgrade initiative for a repo."""
    from github_repo_auditor.initiatives import Initiative, initiatives_path, operator_identity, upsert_initiative
    from github_repo_auditor.maturity_tiers import TIER_DEFINITIONS, compute_tier
...
def run_list_initiatives_mode(args) -> None:
    ...
    from github_repo_auditor.initiatives import derive_status, initiatives_path, load_initiatives
    from github_repo_auditor.maturity_tiers import TIER_DEFINITIONS, compute_tier, tier_name
...
def run_close_initiative_mode(args) -> None:
    ...
    from github_repo_auditor.initiatives import close_initiative, initiatives_path
