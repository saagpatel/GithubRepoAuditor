...
│   ├── excel_export.py         # 10-sheet Excel workbook via openpyxl
...
`output/dashboard-{username}-{date}.xlsx` — 10-sheet workbook (`src/excel_export.py`):
- Summary overview with portfolio KPIs.
- All Repos table with sortable columns.
- Tier breakdown and language distribution.
- Top 10 / Bottom 10 scored repos.
- Activity heatmap.
- Dimension radar chart.
- Security surface sheet.
- Historical diff sheet.
