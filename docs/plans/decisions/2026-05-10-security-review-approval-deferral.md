...
2026-05-17 follow-up: the approval center now withholds approval capture and apply-ready flags when a packet is rollback-blocked or has zero automation-eligible actions, while still keeping the packet visible for manual review.
