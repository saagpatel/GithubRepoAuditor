...
- **Multiple Dashboard Outputs** — Flagship Excel workbook (22+ sheets), interactive HTML dashboard with scatter chart and tech radar, portfolio README, shields.io badges
...
# Generate Excel + HTML dashboard
python -m src <github-username> --output-format excel,html
