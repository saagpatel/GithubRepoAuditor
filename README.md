...
- Review the handoff fields: what changed, why it matters, what to do next, whether the queue is improving or worsening, what was tried for the top target, and whether it is only quieting down or now counts as confirmed resolved
